...
Public Class Paint_Robot_Data
    ...
    Private Sub Paint_Robot_Data_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Update_Screen()
        ...
        query = "exec Paint_Robot_Data '" & DTP_Start_Date.Text & " " & DTP_Start_Time.Text & "', '" & DTP_End_Date.Text & " " & DTP_End_Time.Text & "'"

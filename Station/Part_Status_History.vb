...
Public Class Part_Status_History

    Dim ID_Array() As Int32

    Private bindingsource1 As New BindingSource
    Private Sub Part_Status_History_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Btn_Update_Click(sender As Object, e As EventArgs) Handles Btn_Update.Click
        ...
        If Cmb_Area.SelectedIndex < 0 Then
            ...
            Exit Sub
        End If
        If Cmb_Processes.SelectedIndex < 0 Then
            MsgBox("You must select a valid Process.", MsgBoxStyle.Critical, "Error")
            Exit Sub
        End If
        ...
        query = "exec Part_Status_History '" & DTP_Start_Date.Text & " " & DTP_Start_Time.Text & "', '" & DTP_End_Date.Text & " " & DTP_End_Time.Text & "', " & ID_Array(Cmb_Area.SelectedIndex) & ", " & Cmb_Processes.SelectedIndex

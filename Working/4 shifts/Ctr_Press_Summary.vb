...
Public Class Ctr_Press_Summary
    ...
    Sub update_row(press_id As Integer, press_row As Integer)
        ...
        Try
            ...
            SQLCon.ConnectionString = DBConnection
            SQLCon.Open()
            Dim daCounts_Data As New SqlDataAdapter("Exec Get_Press_Status2 " & press_id, SQLCon)
            ...
            For Each drCounts As DataRow In dsCounts.Tables("Counts").Rows
                ...
                If Press_Hours > 0 Then
                    Me.Controls("lbl_fourth_Total_Rate" & press_row).Text = Format(Val(drCounts("C_Shift_Total") & "") / Press_Hours, "#.0")
                Else

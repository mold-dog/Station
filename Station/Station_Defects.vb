...
Public Class Station_Defects
    ...
    Private Sub DGV_Paint_Data_RowHeaderMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DGV_Paint_Data.RowHeaderMouseDoubleClick
        ...
        Query = "exec Paint_Conveyor_Paint_Runs_Parts '" & DGV_Paint_Data.Rows(e.RowIndex).Cells(2).Value & "', '" & DateAdd(DateInterval.Second, 1, DGV_Paint_Data.Rows(e.RowIndex).Cells(3).Value) & "'"

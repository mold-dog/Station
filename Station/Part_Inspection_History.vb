...
Public Class Part_Inspection_History
    ...
    Private Sub Part_Inspection_History_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub New_Part()
        ...
        query = "Exec Part_Inspection_History " & Part_ID

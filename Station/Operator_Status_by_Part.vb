...
Public Class Operator_Status_by_Part
    ...
    Private bindingsource1 As New BindingSource
        ...
        Private Sub Btn_Update_Click(sender As Object, e As EventArgs) Handles Btn_Update.Click
            ...
            MsgBox("You must select a valid Part Group.", MsgBoxStyle.Critical, "Error")
            Exit Sub
            End If
        ...
        query = "exec Operator_Status_by_Part " & ID_Array(Cmb_Area.SelectedIndex) & ", '" & DTP_Start_Date.Text & " " & DTP_Start_Time.Text & "', '" & DTP_End_Date.Text & " " & DTP_End_Time.Text & "'"
        ...
        Query = "exec Operator_Status_by_Part_Parts '" & DTP_Start_Date.Text & " " & DTP_Start_Time.Text & "', '" & DTP_End_Date.Text & " " & DTP_End_Time.Text & "', " & ID_Array(Cmb_Area.SelectedIndex) & ", '" & DGV_Paint_Data.Rows(e.RowIndex).Cells(0).Value & "'"

...
Public Class Production_Inspections
    Private bindingsource1 As New BindingSource
    Private Sub Production_Defects_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Btn_Update_Click(sender As Object, e As EventArgs) Handles Btn_Update.Click
        ...
        query = "exec Production_Inspections '" & DTP_Start_Date.Text & " " & DTP_Start_Time.Text & "', '" & DTP_End_Date.Text & " " & DTP_End_Time.Text & "'"
    ...
    Private Sub DGV_Paint_Data_RowHeaderMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DGV_Paint_Data.RowHeaderMouseDoubleClick
        ...
        Query = "exec Production_Inspection_Parts " & DGV_Paint_Data.Rows(e.RowIndex).Cells(1).Value & ", '" & DGV_Paint_Data.Rows(e.RowIndex).Cells(2).Value & "', '" & DTP_Start_Date.Text & " " & DTP_Start_Time.Text & "', '" & DTP_End_Date.Text & " " & DTP_End_Time.Text & "'"

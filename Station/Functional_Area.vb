...
Public Class Functional_Area
    ...
    Private Sub Btn_Save_Click(sender As Object, e As EventArgs) Handles Btn_Save.Click
        ...
        If Adding Then
            query = "Insert into functional_area (description) values ('" & Txt_Description.Text & "') "
        Else
            If Cmb_Description.SelectedIndex < 0 Then
                Exit Sub
            End If
            query = "update functional_area Set description = '" & Txt_Description.Text & "' where id = " & ID_Array(Cmb_Description.SelectedIndex)
        End If
    ...
    Private Sub Btn_Delete_Click(sender As Object, e As EventArgs) Handles Btn_Delete.Click
        ...
        SQLCon.ConnectionString = DBConnection
        SQLCon.Open()
        Dim cmd As New SqlCommand("delete from functional_area where id = " & ID_Array(Cmb_Description.SelectedIndex), SQLCon)
        cmd.ExecuteNonQuery()
        SQLCon.Close()
        Call Load_Combo()
        Cmb_Description.Text = ""
    ...
    Private Sub Functional_Area_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call Load_Combo()

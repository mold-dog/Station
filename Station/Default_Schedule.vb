...
Public Class Default_Schedule
    ...
    Private Sub Fill_Grid()
        ...
        query = "Select Default_Schedule.ID, Part_Type.Description as Part_Type, Quantity "
        query = query & "from Default_Schedule inner join part_type on Default_Schedule.Part_Type = Part_Type.ID"
        ...
        Try
            ...
            da.Fill(ds, "Default_Schedule")
            SQLCon.Close()
            For Each dr As DataRow In ds.Tables("Default_Schedule").Rows
        ...
        Catch Ex As Exception
            ...
            MsgBox("Error Getting Defualt Schedule from Database: " & Ex.Message)
        End Try
    ...
    Private Sub Btn_Delete_Click(sender As Object, e As EventArgs) Handles Btn_Delete.Click
        ...
        For Each data_row In DGV_Paint_Data.SelectedRows
            cmd.CommandText = "Delete from Default_Schedule where id = " & data_row.Cells(0).Value
            cmd.ExecuteNonQuery()
        Next
    ...
    Private Sub btn_Add_Recipe_Confirm_Click(sender As Object, e As EventArgs) Handles btn_Add_Recipe_Confirm.Click
        ...
        query = "insert into default_Schedule (Area, Part_Type, Quantity) values(" & ID_Array(Cmb_Area.SelectedIndex) & ", "

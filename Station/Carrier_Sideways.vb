Public Class Carrier_Sideways
    ...
    Private Sub Carrier_Sideways_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LineShape1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles LineShape1.MouseDoubleClick
        Call Open_Carrier_Info()

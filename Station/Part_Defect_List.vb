...
Public Class Part_Defect_List
    Dim ID_Array() As Int32

    Private bindingsource1 As New BindingSource
    Private Sub Part_Defect_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Btn_Update_Click(sender As Object, e As EventArgs) Handles Btn_Update.Click
        ...
        query = "Exec Part_Defect_List " & ID_Array(Cmb_Area.SelectedIndex) & ", '" & DTP_Start_Date.Text & " " & DTP_Start_Time.Text & "', '" & DTP_End_Date.Text & " " & DTP_End_Time.Text & "'"

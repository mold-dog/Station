...
Public Class Part
    ...
    Private Sub Btn_Add_Click(sender As Object, e As EventArgs) Handles Btn_Add.Click
        ...
        Btn_Process_Data.Visible = False
    ...
    Private Sub Final_Part_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Btn_Process_Data.Enabled = User_Permissions_Access_Paint_Area
    ...
    Private Sub Btn_Process_Data_Click(sender As Object, e As EventArgs) Handles Btn_Process_Data.Click
